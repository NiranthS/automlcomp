    ...
    def act(self, state):
        ...
        if self.algorithm == "PPO":
            action = {
                ...
                "vf_coef": self.vf_coefs[min(self.t, len(self.vf_coefs)-1)],
                "ent_coef": self.ent_coefs[min(self.t, len(self.ent_coefs)-1)],
...
def load_solution(
    ...
    DACPolicy
    """
    path = Path(path, 'logs', 'pbt_seed55', 'saved_configs')
